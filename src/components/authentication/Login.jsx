  ...
  return (
    <div className="w-screen flex flex-col">
      ...
      <main className="w-full lg:h-[80vh] flex justify-center items-center bg-[#FCF5D7]">
        {isLoginView ? (
          <motion.div
            className="w-[80%] sm:w-[60%] md:w-[50%] lg:w-[40%] h-[80%] sm:h-[80%] md:h-[80%] lg:h-[90%] rounded-2xl shadow-2xl shadow-black-50 flex flex-col items-center justify-evenly bg-[#5D4037]"
          ...
          >
            ...
            <div className="w-[90%] flex flex-col items-center justify-stretch ">
              <div className="flex flex-col text-md w-full">
                <label className="text-xl mb-2 text-white">Email</label>
                <input
                  type="email"
      ...
      <footer className="w-full h-auto flex flex-col items-center justify-center bg-[#FCF5D7]">
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600 mb-4">
            Copyright © 2025. Zentails Wellness Pvt.Ltd.
          </p>
